...
class _RemindersScreenState extends State<RemindersScreen> {
  ...
  void initState() {
    ...
    ContinuityService.instance.track(
        ContinuityActionType.openedScreen, detail: 'Reminders');
            ...
            child: Column(
              ...
              children: [
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        ss(() { picked = t; smartSuggestion = null; });
                      },
                      child: Row(children: [
                        Container(
                ...
                _sheetSaveBtn('Add Reminder', () async {
                  ...
                  await _svc.add(r);
                  ContinuityService.instance.track(
                      ContinuityActionType.addedReminder, detail: title);
        ...
        actions: [
          ...
          CupertinoActionSheetAction(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              const Icon(CupertinoIcons.tray, size: 16, color: Colors.white54),
          ...
          ...groups.map((g) => CupertinoActionSheetAction(
            onPressed: () async {
              Navigator.of(context).pop();
            ...
            child: Column(
              ...
              children: [
                ...
                _sheetSaveBtn('Save Changes', () async {
                  ...
                  ContinuityService.instance.track(
                      ContinuityActionType.editedReminder, detail: title);
                  if (ctx.mounted) Navigator.of(ctx).pop();
                }),
              ],
            ),
          ...
          Row(children: [
            ...
            if (watched.isNotEmpty)
              Container(
                ...
                child: Text('${watched.length} watching',
                    style: const TextStyle(
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: List.generate(watched.length, (i) {
                  ...
                  final inside = GeofenceService.instance.isInsidePlace(place.id);
                  return Padding(
                    padding: EdgeInsets.only(right: i < watched.length - 1 ? 10 : 0),
                    child: GestureDetector(
                      onTap: widget.onManagePlaces,
...
class _EmptyReminders extends StatelessWidget {
  ...
  static (String emoji, String headline, String sub) _contextFor(DateTime now) {
    final h = now.hour;
    if (h >= 5  && h < 9)  return ('🌅', 'Good morning!',         'Start your day with a reminder.');
    if (h >= 9  && h < 12) return ('☀️', 'Morning\'s rolling.',    'Nothing on your plate yet.');
    if (h >= 12 && h < 14) return ('🌤️', 'Midday check-in.',      'All clear — enjoy your lunch.');
    if (h >= 14 && h < 17) return ('🧠', 'Deep work hours.',       'No interruptions scheduled.');
    if (h >= 17 && h < 20) return ('🌇', 'Evening is yours.',      'Add something to look forward to.');
    if (h >= 20 && h < 23) return ('🌙', 'Winding down.',          'Nothing tonight. Rest well.');
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: const Row(mainAxisSize: MainAxisSize.min, children: [
              ...
              SizedBox(width: 8),
              Text('Add a reminder', style: TextStyle(
                color: Color(0xFF0A84FF), fontSize: 14,
                fontWeight: FontWeight.w600,
              )),
            ]),
          ),
...
class _ClockCalendarPanelState extends State<_ClockCalendarPanel>
  ...
  List<Color> _dotsForDay(DateTime day) {
    final rs = widget.reminders.where((r) =>
        r.dateTime.year  == day.year &&
        r.dateTime.month == day.month &&
        r.dateTime.day   == day.day).toList();
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () => setState(() {
                  if (isCollapsed) _collapsed.remove(sectionId);
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    if (group != null) ...[
                      ...
                      const SizedBox(width: 8),
                      const Text('Ungrouped', style: TextStyle(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: (group?.color ?? Colors.white24)
                            .withOpacity(0.12),
                        borderRadius: BorderRadius.circular(10),
                      ),
                      child: Text('${reminders.length}', style: TextStyle(
