...
void showFinishedBannerIfNeeded(BuildContext context) {
  ...
  final label = isBreak
      ? '${s.sessionType.label} started · ${s.totalSeconds ~/ 60} min'
      ...
      builder: (context, _) {
        ...
        if (svc.pendingFinished) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            if (context.mounted) showFinishedBannerIfNeeded(context);
          });
        }
